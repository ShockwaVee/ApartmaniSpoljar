(function(k, f, c, j, d, l, g) { /*! Jssor */
    ...
    var b = new function() {
        ...
        function Ib() {
            if (!L) {
                L = { Wf: "ontouchstart" in k || "createTouch" in f };
                var a;
        ...
        function ab(a) { a.constructor === ab.caller && a.Md && a.Md.apply(a, ab.caller.arguments) }
        h.Md = ab;
        h.gb = function(a) {
        ...
        function J(a, c, b) { x(a, db(" ", E(bb(R(x(a)), R(c)), R(b)))) }
        h.Bd = function(a) {
            return a.parentNode
        };
        h.Q = function(a) { h.T(a, "none") };
        h.u = function(a, b) { h.T(a, b ? "none" : "") };
        h.fg = function(b, a) { b.removeAttribute(a) };
        h.ag = function() {
            return r() && i < 10
        };
        h.Zf = function(d, a) {
        ...
        h.xg = function(a, b) { n(a, function(a) { h.zb(a, b) }) };
        h.qc = function(a) { h.xg(h.Ab(a, d), a) };
        h.wg = function(a, b) {
            var c = h.Bd(a);
        ...
        h.of = function(b, a) {
            var c = f.body;
            while (a && b !== a && c !== a) try { a = a.parentNode } catch (d) {
                return l
            }
            return b === a
        };
        ...
        var W = { $Opacity: h.yb, $Top: h.z, $Left: h.A, S: h.k, O: h.m, Db: h.B, Ih: h.T, $ZIndex: h.F };
        ...
        var P = { gd: 0, Uc: 0, I: 0, H: 0, $Zoom: 1, $ScaleX: 1, $ScaleY: 1, $Rotate: 0, $RotateX: 0, $RotateY: 0, $TranslateX: 0, $TranslateY: 0, $TranslateZ: 0, $SkewX: 0, $SkewY: 0 };
        h.fc = function(a) {
            var c = a || {};
            if (a)
                if (b.Wc(a)) c = { hc: c };
                else if (b.Wc(a.$Clip)) c.$Clip = { hc: a.$Clip };
            return c
        };
    ...
    function n() {
        ...
        function h(a, b) { d.push({ pc: a, oc: b }) }

        function g(a, c) { b.a(d, function(b, e) { b.pc == a && b.oc === c && d.splice(e, 1) }) }
        a.$On = a.addEventListener = h;
        a.$Off = a.removeEventListener = g;
        a.l = function(a) {
            var c = [].slice.call(arguments, 1);
            b.a(d, function(b) { b.pc == a && b.oc.apply(k, c) })
        }
    }
    var m = function(z, C, h, L, O, J) {
            ...
            if (!D || v || g != j) {
                ...
                if (!D || v || k != m) {
                    if (J) {
                        ...
                        if (x) b.a(n, function(b, a) { x[a] && x[a](L, b) });
                        else b.K(L, n)
                    }
                    a.nc(m - i, k - i);
                    m = k;
        ...
        if (b.jf() && b.Jd() < 7) r = j;
        r = r || function(a) { b.$Delay(a, h.$Interval) };
        ...
        a.$Play = function(a, b, c) { t(a ? g + a : e, b, c) };
        a.Lc = t;
        a.pb = M;
        a.Oe = function(a) { t(a) };
        a.W = function() {
        ...
        a.D = u;
        a.$Move = function(a) { u(g + a) };
        a.$IsPlaying = function() {
            return q
        };
        a.Ae = function(a) { p = a };
        a.$Shift = P;
        a.wb = function(a, b) { E(a, 0, b) };
        a.rc = function(a) { E(a, 1) };
        a.Fe = function(a) { e += a };
        a.jc = function() {
            return f
        };
    ...
    k.$JssorSlideshowRunner$ = function(k, s, q, u, z) {
        ...
        function t(a) {
            ...
            b.a(a, function(a) { b.Yc(a) && t(a) })
        }

        function i(g, f) {
            var a = { $Interval: f, $Duration: 1, $Delay: 0, $Cols: 1, $Rows: 1, $Opacity: 0, $Zoom: 0, $Clip: 0, $Move: l, $SlideOut: l, $Reverse: l, $Formation: p.$FormationRandom, $Assembly: 1032, $ChessMode: { $Column: 0, $Row: 0 }, $Easing: e.$EaseSwing, $Round: {}, Kb: [], $During: {} };
            b.o(a, g);
            t(a);
            a.Ib = a.$Cols * a.$Rows;
            ...
            a.Od = function(c, b) {
                ...
                if (!a.Kb[f]) {
                    ...
                    for (var d = 0; d < a.$Cols; d++)
                        for (var e = 0; e < a.$Rows; e++) a.Kb[f][e + "," + d] = { $Top: e * b, $Right: d * c + c, $Bottom: e * b + b, $Left: d * c }
                }
                return a.Kb[f]
            };
            if (a.$Brother) {
        ...
        function o(B, h, a, w, o, m) {
            ...
            b.a(p, function(h, j) {
                b.a(h, function(G) {
                    ...
                    i[t].ee = y + D - 1;
                    for (var F = 0; F <= D; F++) {
                        var E = b.Tc(f, s, F / D, a.$Easing, a.$During, a.$Round, { $Move: a.$Move, $OriginalWidth: o, $OriginalHeight: m });
                        E.$ZIndex = E.$ZIndex || 1;
                        i[t].push(E)
                    }
                })
    ...
    var i = k.$JssorSlider$ = function(p, hc) {
        ...
        function Dc() {
            var a = this,
                b = Vb.$Elmt;
            m.call(a, -1, 2, { $Easing: e.$EaseLinear, Be: { Db: bc }, pd: r }, b, { Db: 1 }, { Db: -2 });
            a.Yb = b
        }
        ...
        function Bc(k, f) {
            ...
            function eb() { s == f && g && g.pb() }

            function Z(a) {!M && h.l(i.$EVT_CLICK, f, a) }
        ...
        function zc(y, f, p, q) {
            ...
            a.Ke = function() { e == c && e == a.qb() && a.D(j) };
            a.de = function() {
                A && A.ob == f && A.tb();
                var b = a.qb();
                b < c && h.l(i.$EVT_STATE_CHANGE, f, -b - 1, n, j, e, c)
            };
            a.fd = function(a) { p && b.kb(ib, a && p.yc.$Outside ? "" : "hidden") };
            a.nc = function(b, a) {
                if (k && a >= g) {
                    k = l;
                    v();
        ...
        function Ib(a) {!b.j(b.mc(a), "nodrag") && b.Pb(a) }
        ...
        function zb() { b.a(S, function(a) { a.gc(a.Nb.$ChanceToShow <= F) }) }
        ...
        n.call(h);
        h.$Elmt = p = b.gb(p);
        var a = b.o({ $FillMode: 1, $LazyLoading: 1, $ArrowKeyNavigation: 1, $StartIndex: 0, $AutoPlay: l, $Loop: 1, $HWA: d, $NaviQuitDrag: d, $AutoPlaySteps: 1, $AutoPlayInterval: 3e3, $PauseOnHover: 1, $SlideDuration: 500, $SlideEasing: e.$EaseOutQuad, $MinDragOffsetToSlide: 20, $SlideSpacing: 0, $Cols: 1, $Align: 0, $UISearchMode: 1, $PlayOrientation: 1, $DragOrientation: 1 }, hc);
        a.$HWA = a.$HWA && b.nf();
        ...
        var s = -1,
            ...
            Z, Nb = [];
        if (r) {
            if (a.$HWA) Mb = function(a, c, d) { b.Eb(a, { $TranslateX: c, $TranslateY: d }) };
            P = a.$AutoPlay;
            h.Nb = hc;
            lc();
    ...
    k.$JssorBulletNavigator$ = function(e, C) {
        ...
        function v(a) { a != -1 && y[a].Jc(a == k) }

        function t(a) { f.l(o.Lb, a * m) }
        f.$Elmt = e;
        f.Ec = function(a) {
            if (a != r) {
                var d = k,
        ...
        f.Nb = a = b.o({ $SpacingX: 10, $SpacingY: 10, $Orientation: 1, $ActionMode: 1 }, C);
        g = b.C(e, "prototype");
        q = b.k(g);
        p = b.m(g);
        b.zb(g, e);
    ...
    k.$JssorThumbnailNavigator$ = function(g, B) {
        ...
        h.Nb = a = b.o({ $SpacingX: 0, $SpacingY: 0, $Cols: 1, $Orientation: 1, $AutoCenter: 3, $ActionMode: 1 }, B);
        z = b.k(g);
        x = b.m(g);
        f = b.C(g, "slides", d);
        k = b.C(f, "prototype");
    ...
    k.$JssorCaptionSlideo$ = function(n, f, l) {
        ...
        function r(e, f, a) {
            b.a(f, function(h) {
                ...
                var i = { $Easing: g, $OriginalWidth: a.S, $OriginalHeight: a.O },
        ...
        function q(a) {
            b.a(a, function(f) {
                var a = f.$Elmt,
                    e = b.k(a),
                    d = b.m(a),
                    c = { $Left: b.A(a), $Top: b.z(a), I: 0, H: 0, $Opacity: 1, $ZIndex: b.F(a) || 0, $Rotate: 0, $RotateX: 0, $RotateY: 0, $ScaleX: 1, $ScaleY: 1, $TranslateX: 0, $TranslateY: 0, $TranslateZ: 0, $SkewX: 0, $SkewY: 0, S: e, O: d, $Clip: { $Top: 0, $Right: e, $Bottom: d, $Left: 0 } };
                c.gd = c.$Left;
                c.Uc = c.$Top;
                r(a, f.yc, c)
            })
        ...
        b.a(u, function(b, a) { g[b] = a });
        q(k(n, 1));
        c.D(-1);
        var p = f.$Breaks || [],
            e = [].concat(p[b.zc(b.j(n, "b"))] || []);
        e.push({ b: c.Zb(), d: e.length ? 0 : l });
        s(e);
        a.D(-1)
    }
